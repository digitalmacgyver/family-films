"""
Django settings for family_films project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-xsfmz_q-canrthuh97er!)a2utkx-sumo0!w2hippcz@dsg9ex')
...
ROOT_URLCONF = 'family_films.urls'
...
WSGI_APPLICATION = 'family_films.wsgi.application'
